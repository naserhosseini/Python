...
def Results():
    ...
    global G_CL_PKN_C, G_lgt_PKN_C, G_K_PKN_C, Mass_PKN_C, Ms_PKN_C, CL_PKN_T, G_lgt_PKN_T, G_K_PKN_T, Mass_PKN_T, Ms_PKN_T
    global G_CL_RDL_C, sf_RDL_C, G_lgt_RDL_C, G_K_RDL_C, Mass_RDL_C, Ms_RDL_C, sf_RDL_T, CL_RDL_T, G_lgt_RDL_T, G_K_RDL_T, Mass_RDL_T, Ms_RDL_T
    global H_A_K
