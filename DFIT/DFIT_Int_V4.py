...
@app.callback(
    [Output(component_id='Graph',component_property='figure'),
     ...
     Output(component_id='h_function', component_property='children'),
...
def Update_Graph(G, Slope, Ver, Fit, Click):
    ...
    fig2.update_yaxes(title_text='Mass balance residual (bbl)',row=1,col=1)
    ...
    H_FUN_RES='H_Shut: ',h_Shut,'h_peak',h_Peak
    ...
    Old_Click=Click
    return fig1,SminC, SminT, ISIP, fig2, PermBar, H_FUN_RES,PST
