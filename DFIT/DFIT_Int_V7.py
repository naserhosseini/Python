...
MainFig.add_trace(
    #go.Scatter(x=[0,1], y=[0,1], name='Pressure', line=dict(color='blue')),
    #secondary_y=False, row=1, col=1
    go.Scatter(x=Time, y=Pressure, name='Pressure', line=dict(color='blue')),
    secondary_y=False, row=1, col=1
)

MainFig.add_trace(
    #go.Scatter(x=[0,1], y=[0,1], name='Rate', line=dict(color='red')),
    #secondary_y=True, row=1, col=1
    go.Scatter(x=Time, y=Rate, name='Rate', line=dict(color='red')),
    secondary_y=True, row=1, col=1
)
...
def Update_Graph(G, Slope, Ver, Fit, Click,ClsPrs):
    global pg,gpg, Old_Click, ShminC, ShminT
    ...
    ShminC=ClsPrs
    SminC='Minimum Principle Stress (Compliance) is: ',ShminC

    ShminT=Prs_Shut[Ver]
    SminT='Minimum Principle Stress (Tangent) is: ',ShminT
    if Fit=='Original':
        pg=dp_dg_1
        gpg=gdp_dg_1
    else:
